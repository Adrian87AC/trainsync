...
const Login = () => {
    ...
    return (
        <div className="min-vh-100 d-flex align-items-center justify-content-center bg-transparent">
            <div className="card shadow-lg border-0" style={{ maxWidth: '400px', width: '100%', borderRadius: '15px', background: 'rgba(255, 255, 255, 0.9)', backdropFilter: 'blur(10px)' }}>
                <div className="card-body p-5">
                    <div className="text-center mb-4">
                        ...
                        <p className="text-muted small">Inicia sesión en TrainSync</p>
                    </div>
