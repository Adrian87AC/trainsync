    ...
    return (
        <div className="container py-5">
            <div className="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 className="fw-bold h3 mb-0">Panel de Administración</h1>
                    <p className="text-muted">Gestiona cuentas de coaches y clientes</p>
                </div>
                        ...
                        <tbody>
                            {users.map(u => (
                                <tr key={u.id}>
                                    ...
                                    <td className="py-3">
                                        {u.trainer_name ? (
                                            <span className="text-muted small">Asignado a: <br /><strong>{u.trainer_name}</strong></span>
                                        ) : (
                                    ...
                                    <td className="py-3 text-end pe-4">
                                        <div className="dropdown d-inline-block">
                                            <button className="btn btn-light btn-sm rounded-3 me-2" type="button" onClick={() => {
